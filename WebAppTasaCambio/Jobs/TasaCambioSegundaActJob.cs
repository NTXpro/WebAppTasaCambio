...
{
    public class TasaCambioSegundaActJob : IJob
    {
        ...
        public void Execute(IJobExecutionContext context)
        {
            ...
            int HoraIPBS = 0;
            convert = int.TryParse(ConfigurationManager.AppSettings["HoraInicioSegundaBusquedaSunat"], out HoraIPBS);
            int HoraFPBS = 0;
            convert = int.TryParse(ConfigurationManager.AppSettings["HoraFinSegundaBusquedaSunat"], out HoraFPBS);
            ...
            if (HoraActual >= HoraIPBS && HoraActual <= HoraFPBS)
            {
                ...
                Proceso proceso = new Proceso();
                    ...
                    tasaCambioModule.PrimerValor(xfecha.AddDays(1), 2);
                ...
                //Proceso proceso = new Proceso();
                //proceso = tasaCambioModule.PrimerValor(TiempoActual);
                //if (proceso.Tipo == "Insertar")
                //{
                //    ActualizarTodasBasesDatos act = new ActualizarTodasBasesDatos();
                //    //------------------------
                //    List<BasesDatos> lista = new List<BasesDatos>();
                //    lista.Add(new BasesDatos { ID = 1, NombreBD = "DB_A42167_Pruebas4", RptDS = "sql5017.site4now.net", password = "Quipu2016", usuario = "DB_A42167_ReportingService_admin" });
                //    //------------------------
                //    act.ActTasaCambio(lista, proceso.TasaCambioDiaria);
                //   // act.ActTasaCambio(proceso.ListaBaseDatos, proceso.TasaCambioDiaria);
                //}            
